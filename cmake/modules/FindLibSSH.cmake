...
if (LIBSSH_LIBRARIES AND LIBSSH_INCLUDE_DIRS)
    ...
    if (SSH_FOUND)
        ...
        if (LibSSH_FIND_VERSION)
            set(VERSION_HEADER "libssh_version.h")
            if(NOT EXISTS "${LIBSSH_INCLUDE_DIR}/libssh/${VERSION_HEADER}")
                set(VERSION_HEADER "libssh.h")
            endif(NOT EXISTS "${LIBSSH_INCLUDE_DIR}/libssh/${VERSION_HEADER}")

            file(STRINGS ${LIBSSH_INCLUDE_DIR}/libssh/${VERSION_HEADER} LIBSSH_VERSION_MAJOR
                REGEX "#define[ ]+LIBSSH_VERSION_MAJOR[ ]+[0-9]+")
            # Older versions of libssh like libssh-0.2 have LIBSSH_VERSION but not LIBSSH_VERSION_MAJOR
            if (LIBSSH_VERSION_MAJOR)
                string(REGEX MATCH "[0-9]+" LIBSSH_VERSION_MAJOR ${LIBSSH_VERSION_MAJOR})
                file(STRINGS ${LIBSSH_INCLUDE_DIR}/libssh/${VERSION_HEADER} LIBSSH_VERSION_MINOR
                    REGEX "#define[ ]+LIBSSH_VERSION_MINOR[ ]+[0-9]+")
                string(REGEX MATCH "[0-9]+" LIBSSH_VERSION_MINOR ${LIBSSH_VERSION_MINOR})
                file(STRINGS ${LIBSSH_INCLUDE_DIR}/libssh/${VERSION_HEADER} LIBSSH_VERSION_PATCH
                ...
                message(STATUS "LIBSSH_VERSION_MAJOR not found in ${LIBSSH_INCLUDE_DIR}/libssh/${VERSION_HEADER}, assuming libssh is too old")
