...
BuildRequires:  binutils gcc tar cmake libssh-devel >= 0.5.0 libssl-devel >= 1.0 doxygen
Requires:       libssh >= 0.5.0 libssl >= 1.0
...
Group:          Development/Libraries
Requires:       %{name} = %{version}-%{release} libssh-devel >= 0.5.0 libssl-devel >= 1.0
